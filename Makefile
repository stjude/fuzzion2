...
FUZZION2_SRC_BASENAMES=fuzzion2.cpp align.cpp bamread.cpp bin.cpp hit.cpp kmer.cpp match.cpp \
	minimizer.cpp pattern.cpp rank.cpp read.cpp refgen.cpp util.cpp window.cpp
...
FUZZALL_SRC_BASENAMES=fuzzall.cpp align.cpp hit.cpp kmer.cpp match.cpp minimizer.cpp \
...
FUZZHOP_NAME=fuzzhop
FUZZHOP_BIN=$(BIN_PREFIX)/$(FUZZHOP_NAME)
FUZZHOP_SRC_BASENAMES=fuzzhop.cpp align.cpp hit.cpp kmer.cpp match.cpp minimizer.cpp \
	pattern.cpp util.cpp window.cpp
FUZZHOP_SRCS=$(FUZZHOP_SRC_BASENAMES:%.cpp=$(SRC_PREFIX)/%.cpp)
FUZZHOP_OBJS=$(FUZZHOP_SRC_BASENAMES:%.cpp=$(OBJ_PREFIX)/%.o)

FUZZION2HTML_NAME=fuzzion2html
FUZZION2HTML_BIN=$(BIN_PREFIX)/$(FUZZION2HTML_NAME)
FUZZION2HTML_SRC_BASENAMES=fuzzion2html.cpp align.cpp group.cpp hit.cpp kmer.cpp match.cpp \
...
FUZZORT_SRC_BASENAMES=fuzzort.cpp align.cpp hit.cpp kmer.cpp match.cpp minimizer.cpp \
	pattern.cpp util.cpp window.cpp
...
FUZZUM_SRC_BASENAMES=fuzzum.cpp align.cpp group.cpp hit.cpp kmer.cpp match.cpp \
	minimizer.cpp pattern.cpp summary.cpp util.cpp window.cpp
...
all: $(FUZZION2_BIN) $(FUZZALL_BIN) $(FUZZHOP_BIN) $(FUZZION2HTML_BIN) $(FUZZORT_BIN) $(FUZZUM_BIN) $(KMERANK_BIN)
...
$(FUZZHOP_BIN): $(FUZZHOP_OBJS) | $(BIN_PREFIX)
	$(CXX) $^ $(CXXFLAGS) -o $@
$(FUZZHOP_NAME): $(FUZZHOP_BIN)
